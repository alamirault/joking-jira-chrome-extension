            ...
            <div className="container">
                ...
                <div className="d-flex justify-content-between">
                    <label htmlFor="sprintGoalAsTitle" className="d-block me-1">
                        ...
                        <p className="my-0">Add a title attribute to sprint goal so it can be displayed properly on
                            hover</p>
                    </label>
                    <Switch
                        ...
                        onChange={(value: boolean) => saveOptions('sprintGoalAsTitle', value)}
                    />
                </div>
                ...
                <div className="d-flex justify-content-between">
                    <label htmlFor="disableEmojiAutocomplete" className="d-block me-1">
                        ...
                        <p className="my-0">Automatically add a space after any colon typed in order to prevent emojis
                            autocomplete to disturb typing</p>
                    </label>
                    <Switch
                        ...
                        onChange={(value: boolean) => saveOptions('disableEmojiAutocomplete', value)}
                    />
                </div>
                ...
                <div className="d-flex justify-content-between">
                    <label htmlFor="forceDisplayCopyLink" className="d-block me-1">
                        ...
                        <p className="my-0">Add custom CSS to make copy issue link button always visible in issue breadcrumbs</p>
                    </label>
                    <Switch
                        ...
                        onChange={(value: boolean) => saveOptions('forceDisplayCopyLink', value)}
                    />
                </div>

                <p className="text-center text-secondary mb-0 mt-2">Made from frustration</p>
